...
囲碁AIを使った検討や勝率の表示を行いながら、囲碁対局を検討するためのソフトウェアです。竜星戦や囲碁プレミアムなどで検討が行えるよう、既存の囲碁検討ソフトである [Sabaki](https://github.com/SabakiHQ/Sabaki) を改修し必要な機能を追加しています。このマニュアルでは主にその追加機能に関して説明します。
...
- **解説室**： 本譜とAIによる勝率などを参考にしながら解説を行います。解説では対局室で入力される本譜の手を自動更新するため何もせず最新の手を見ることができます。また、検討モードでは自由に石を置き検討を行えます。
...
デザイン画面は操作用画面とは別のウィンドウで表示します。このウィンドウのみを別ディスプレイに出力することで、配信画面などに取り込むことができます。
...
- **ウィンドウの移動**：　マウスドラッグにより移動できます。
- **ウィンドウのリサイズ**：　ウィンドウ枠をドラッグします。
